...
Class Controller {
    ...
    public function index() {
        ...
        switch ($page) {
            ...
            case ($page === "data-entries"):
                if ($_SESSION['usertype'] == 'ADMIN') {
                    require "Views/data-entries.php";
                }
                else
                {
                    header("location: ?p=error");
            ...
            case ($page === "load"):
                ...
                if (isset($_POST['load'])) {
                    ...
                    if ($load == 'selectdataentries') {
                        echo json_encode($this->db->selectDataEntries());
                        exit();
                    }
            ...
            case ($page === "submit"):
                ...
                if (isset($_POST['submit']))
                {
                    ...
                    if ($submit == 'deletedataentry') {
                        echo $this->db->deleteDataEntry($_POST['deleteid']);
                        exit();
                    }
                    ...
                    if ($submit == 'updatedataentry') {

                        $data = [
                            'monthlyproductiondataid' => $_POST['updateid'],
                            'd10' => $_POST['d10'],
                            'e10' => $_POST['e10'],
                            'd11' => $_POST['d11'],
                            'd12' => $_POST['d12'],
                        ...
                        echo $this->db->updateDataEntry($data);
                        exit();
                    }
