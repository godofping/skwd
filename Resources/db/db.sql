...
insert  into `monthly_production_data`(`monthlyproductiondataid`,`pumpingstationuserid`,`d10`,`e10`,`d11`,`d12`,`d13`,`d15`,`d16`,`d17`,`d19`,`d20`,`d21`,`d23`,`e23`,`d24`,`e24`,`d25`,`e25`,`e26`,`c27`,`d27`,`d30`,`e30`,`d31`,`e31`,`d32`,`e32`,`e33`,`c34`,`d34`,`d38`,`d39`,`d40`,`d43`,`e43`,`d44`,`e44`,`d45`,`e45`,`e46`,`c47`,`d47`,`d50`,`e50`,`d51`,`e51`,`d52`,`e52`,`e53`,`c55`,`d55`,`d58`,`e58`,`d59`,`e59`,`e60`,`d61`,`e61`,`d62`,`e62`,`e63`,`e65`,`forval`,`datecreated`) values (3,16,32,51855.36,21407.35,20958.18,449.17,13,5,8,2702417.4,2646455.9,55961.5,1,1,2,0.03,3,0,1.03,124.59,128.33,2,2,3,0.05,4,0,2.05,124.59,900.2,2360572.2,2246270,114302.2,50,50,30,0.5,5,0,50.5,0.001,0.05,560,560,30,0.5,30,0.01,560.51,0.001,0.56,4,4,49,0.82,4.82,0,0,62,1.03,1.03,5.85,67.52,'2020-11-25'),(5,0,32,51855.36,21407.35,20958.18,449.17,13,5,8,2702417.4,2646455.9,55961.5,1,1,2,0.03,3,0,1.03,124.59,128.33,2,2,3,0.05,4,0,2.05,124.59,900.2,2360572.2,2246270,114302.2,50,50,30,0.5,5,0,50.5,0.001,0.05,560,560,30,0.5,30,0.01,560.51,0.001,0.56,4,4,49,0.82,4.82,0,0,62,1.03,1.03,5.85,67.52,'2020-11-25'),(6,0,32,51855.36,21407.35,20958.18,449.17,13,5,8,2702417.4,2646455.9,55961.5,1,1,2,0.03,3,0,1.03,124.59,128.33,2,2,3,0.05,4,0,2.05,124.59,900.2,2360572.2,2246270,114302.2,50,50,30,0.5,5,0,50.5,0.001,0.05,560,560,30,0.5,30,0.01,560.51,0.001,0.56,4,4,49,0.82,4.82,0,0,62,1.03,1.03,5.85,67.52,'2020-11-25'),(7,NULL,32,51847.68,21407.35,20958.18,449.17,13,5,8,2702417.4,2646455.9,55961.5,1,1,2,0.03,3,0,1.03,124.59,128.33,2,2,3,0.05,4,0,2.05,124.59,900.2,2360572.2,2246270,114302.2,50,50,30,0.5,5,0,50.5,0.001,0.05,560,560,30,0.5,30,0.01,560.51,0.001,0.56,4,4,49,0.82,4.82,0,0,62,1.03,1.03,5.85,67.51,NULL),(8,NULL,32,51847.68,21407.35,20958.18,449.17,13,5,8,2702417.4,2646455.9,55961.5,1,1,2,0.03,3,0,1.03,124.59,128.33,2,2,3,0.05,4,0,2.05,124.59,900.2,2360572.2,2246270,114302.2,50,50,30,0.5,5,0,50.5,0.001,0.05,560,560,30,0.5,30,0.01,560.51,0.001,0.56,4,4,49,0.82,4.82,0,0,62,1.03,1.03,5.85,67.51,NULL),(9,16,55,33000,55,2,53,555,5,550,5555,585,4970,55,55,5,0.08,5,0,55.08,93.77,5164.85,5,5,5,0.08,5,0,5.08,93.77,558,5,8,-3,8,8,8,0.13,8,0,8.13,0.001,0.01,25,25,55,0.92,55,0.02,25.94,0.001,0.03,5,5,5,0.08,5.08,5,5,5,0.08,5.08,10.16,25,'2020-11-25'),(10,16,32,51840,21407.35,20958.18,449.17,13,5,8,2702417.4,2646455.9,55961.5,1,1,2,0.03,3,0,1.03,124.59,128.33,2,2,3,0.05,4,0,2.05,124.59,900.2,2360572.2,2246270,114302.2,50,50,30,0.5,5,0,50.5,0.001,0.05,23,23,3,0.05,3,0,23.05,0.001,0.02,2,2,2,0.03,2.03,2,2,2,0.03,2.03,4.06,67.5,'2020-11-26');
...
/*Table structure for table `view_dashboard` */
...
/*!50001 CREATE TABLE  `view_dashboard`(
 `users` bigint(21) ,
 `areas` bigint(21) ,
 `pumpstations` bigint(21) ,
 `dataentries` bigint(21) 
)*/;
...
/*View structure for view view_dashboard */

/*!50001 DROP TABLE IF EXISTS `view_dashboard` */;
/*!50001 DROP VIEW IF EXISTS `view_dashboard` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_dashboard` AS select (select count(0) from `user` where (`user`.`usertype` = 'USER')) AS `users`,(select count(0) from `area`) AS `areas`,(select count(0) from `pumping_station`) AS `pumpstations`,(select count(0) from `monthly_production_data`) AS `dataentries` */;
